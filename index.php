...
<header class="text-center font-weight-bold" style="margin-top: 50px; font-size: x-large">
    Juan Ignacio Andrade
</header>
<div class="row">
    <div class="col-md-4 offset-md-4" style="padding: 20px">
        <img src="img.jpg" alt="foto" style="max-width: 100%">
    </div>
</div>
<div class="row">
